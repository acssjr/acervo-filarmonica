...
"[project]/frontend-next/app/(auth)/acervo/[categoria]/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function CategoriaPage() {
    _s();
    const { categoria } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2d$next$2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useParams"])();
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2d$next$2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"])();
    ...
    const filteredSheets = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2d$next$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "CategoriaPage.useMemo[filteredSheets]": ()=>{
            const catId = selectedCategory ?? categoria;
            if (!catId) return sheets;
            return sheets.filter({
                "CategoriaPage.useMemo[filteredSheets]": (s)=>s.category === catId
            }["CategoriaPage.useMemo[filteredSheets]"]);
        }
    }["CategoriaPage.useMemo[filteredSheets]"], [
        sheets,
    ...
    const handleBack = (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2d$next$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "CategoriaPage.useCallback[handleBack]": ()=>{
...
_s(CategoriaPage, "EsQL+6yEwHWg19SyLarhJqUEqZA=", false, function() {
    return [
...
//# sourceMappingURL=frontend-next_a669896b._.js.map