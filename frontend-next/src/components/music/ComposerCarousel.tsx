            ...
            return (
              ...
              >
                ...
                <div style={{ position: 'absolute', bottom: '10px', left: '10px', right: '10px', padding: '10px 12px', borderRadius: '10px', background: 'rgba(255, 255, 255, 0.1)', backdropFilter: 'blur(12px)', WebkitBackdropFilter: 'blur(12px)', border: '1px solid rgba(255, 255, 255, 0.15)', textAlign: 'left' }}>
                  <p style={{ fontFamily: "'Outfit', sans-serif", fontSize: '14px', fontWeight: '700', color: '#FFFFFF', marginBottom: '2px', textShadow: '0 1px 2px rgba(0,0,0,0.3)' }}>
                    {composer.name}
                  </p>
                  <p style={{ fontFamily: "'Outfit', sans-serif", fontSize: '11px', color: 'rgba(255, 255, 255, 0.8)', display: 'flex', alignItems: 'center', gap: '4px' }}>
                ...
                {isFirst && (
                  <div style={{ position: 'absolute', top: '10px', right: '10px', padding: '3px 8px', borderRadius: '20px', background: 'linear-gradient(145deg, #D4AF37 0%, #B8860B 100%)', fontSize: '10px', fontWeight: '600', color: '#1A1A1A', fontFamily: "'Outfit', sans-serif", boxShadow: '0 2px 8px rgba(212, 175, 55, 0.4)' }}>
                    Destaque
                  </div>
                )}
              </button>
