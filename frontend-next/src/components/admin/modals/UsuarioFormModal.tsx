    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "28px" }}>
          <h2 style={{ fontSize: "22px", fontWeight: "600", color: "var(--text-primary)", margin: 0, fontFamily: "var(--font-sans)" }}>
        ...
        {/* Nome Completo */}
        <label style={{ display: "block", fontSize: "13px", fontWeight: "600", marginBottom: "8px", color: "var(--text-secondary)", fontFamily: "var(--font-sans)" }}>
        ...
        {!usuario && (
          <>
            ...
            <p style={{ fontSize: "12px", color: "var(--text-muted)", marginTop: "-12px", marginBottom: "20px", fontFamily: "var(--font-sans)" }}>
        ...
        <label style={{
          ...
          />
          <div>
            <span style={{ color: "var(--text-primary)", fontWeight: "500", fontSize: "14px", fontFamily: "var(--font-sans)" }}>
              Este músico é administrador
            </span>
            <p style={{ fontSize: "12px", color: "var(--text-muted)", margin: "4px 0 0 0", fontFamily: "var(--font-sans)" }}>
