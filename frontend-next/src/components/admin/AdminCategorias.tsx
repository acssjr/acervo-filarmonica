...
const AdminCategorias = () => {
  ...
  return (
    <div className="page-transition" style={{ padding: "32px", maxWidth: "800px", margin: "0 auto", fontFamily: "var(--font-sans)" }}>
      {/* Header */}
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "24px" }}>
              <h2 style={{ fontSize: "20px", fontWeight: "600", color: "var(--text-primary)", margin: 0, fontFamily: "var(--font-sans)" }}>
