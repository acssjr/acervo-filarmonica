...
const HomeHeader = ({ userName, instrument, actions }: HomeHeaderProps) => {
  ...
  const renderRehearsalInfo = () => {
    ...
    if (rehearsalInfo.isNow) {
      return (
        <div style={{ display: "flex", alignItems: "center", gap: "8px", marginTop: "12px" }}>
          ...
          <span style={{
            fontFamily: "var(--font-sans)", fontSize: "14px", fontWeight: "700", color: "#22C55E",
          }}>
    ...
    return (
      <div style={{ display: "flex", alignItems: "center", gap: "8px", marginTop: "12px" }}>
        <span style={{
          fontFamily: "var(--font-sans)", fontSize: "13px", fontWeight: "700", color: "var(--text-muted)",
        }}>
          Próximo ensaio:
        </span>
        <div style={{
          ...
          {rehearsalInfo.days !== undefined && rehearsalInfo.days > 0 && (
            <span style={{ fontFamily: "var(--font-sans)", fontSize: "14px", fontWeight: "800", color: "#D4AF37" }}>
          ...
          <span style={{ fontFamily: "var(--font-sans)", fontSize: "12px", color: "var(--text-muted)", fontWeight: "500" }}>
