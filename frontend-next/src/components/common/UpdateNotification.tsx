    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          <p style={{ margin: 0, fontSize: "13px", fontWeight: "600", color: "var(--text-primary)", fontFamily: "Outfit, sans-serif" }}>
            Nova versao disponivel
          </p>
          <p style={{ margin: "2px 0 0", fontSize: "11px", color: "var(--text-muted)", fontFamily: "Outfit, sans-serif" }}>
