...
const MenuIcon = ({ type, active }: MenuIconProps) => {
...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <AdminContext.Provider value={{ stats, loading, activeSection, navigateToSection, refreshStats: loadStats }}>
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              <div style={{ display: "flex", alignItems: "center", gap: "12px", justifyContent: sidebarCollapsed && !isMobile ? "center" : "flex-start", flex: 1 }}>
                ...
                {(!sidebarCollapsed || isMobile) && (
                  <div>
                    <div style={{ fontWeight: "700", color: "#F4E4BC", fontSize: "14px", fontFamily: "var(--font-sans)" }}>S.F. 25 de Março</div>
                    <div style={{ fontSize: "11px", color: "#D4AF37", fontFamily: "var(--font-sans)" }}>PAINEL ADMIN</div>
                  </div>
                )}
              </div>
