...
const detectInstrumento = (filename) => {
  ...
  const patterns = [
    ...
    { pattern: /(?:bombardino|euph(?:onium)?|euf(?:[oô]nio)?)[\s._-]*(?:(?:em|in)[\s._-]*)?(?:bb|b♭|sib|si[\s._-]*bemol)\b/i, name: 'Bombardino Bb' },
    { pattern: /(?:bombardino|euph(?:onium)?|euf(?:[oô]nio)?)[\s._-]*(?:(?:em|in)[\s._-]*)?(?:c|d[oó])\b/i, name: 'Bombardino C' },
    { pattern: /(?:bombardino|euph(?:onium)?|euf(?:[oô]nio)?)[\s._-]*(?:(?:em|in)[\s._-]*)?(?:eb|mib|mi[\s._-]*bemol)\b/i, name: 'Bombardino Eb' },
    { pattern: /bombardino|euph|euf[oô]nio|flicorne/i, name: 'Bombardino C' },
    ...
    { pattern: /\beuf\d*\b/i, name: 'Bombardino C' },
...
const AdminPartituras = () => {
  ...
  // Usa função matchesSearch de module-level (não recriada a cada render)
