...
// Passos separados para mobile e desktop devido às diferenças de layout

// Passos para DESKTOP (sidebar, barra de busca no header)
export const DESKTOP_WALKTHROUGH_STEPS = [
  {
    id: 'search',
  ...
  },
  {
    ...
    description: 'Clique em qualquer card para ver os detalhes e opções de download.',
    position: 'bottom',
    highlightPadding: 8
  },
  {
...
export const MOBILE_WALKTHROUGH_STEPS = [
  {
    id: 'featured',
    targetSelector: '[data-walkthrough="featured"]',
    title: 'Destaques',
