...
/**
 * Retrieve the parts for a given score, ordered by a predefined instrument hierarchy and then by instrument name.
 * @param {number|string} partituraId - The ID of the score (partitura) whose parts should be returned.
 * @returns {Array<{id: number, instrumento: string, arquivo_nome: string|null, criado_em: string}>} An array of part objects containing `id`, `instrumento`, `arquivo_nome`, and `criado_em`.
 */
